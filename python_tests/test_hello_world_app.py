        ...
        with open(hostYaml, 'r') as ymlfile1:  # hosts to test
            ...
            for host in contents['hosts']:
                if ("master" in host['name']):
                    ip=host['value']
                    curlcmd = "curl -X POST -H \"Host: front.nodejs-hello-world-app.prsn-dev.io\" -H \"Content-Type: application/json\" -d \"{\\\"data\\\": \\\"blah\\\", \\\"username\\\": \\\"admin\\\", \\\"password\\\": \\\"password\\\"}\" http://front.nodejs-hello-world-app.prsn-dev.io"
